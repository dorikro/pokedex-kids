...
export const he: TranslationDictionary = {
  ...
  // ─── Game / v0.2 ─────────────────────────────────────────────────
  game: {
    starterTitle: "!בחרו את פוקימון ההתחלה שלכם",
    starterSubtitle: "בחרו אחד משלושת אלה כדי להתחיל את ההרפתקה.",
    starterChoose: "בחר",
    starterConfirm: "!התחל הרפתקה",
    trainerNameLabel: "שם המאמן שלך",
    trainerNamePlaceholder: "...הכניסו את שמכם",
    partyTitle: "הקבוצה שלי",
    partySubtitle: "צוות הפוקימונים הפעיל שלך",
    partySlot: (n: number) => `מקום ${n}`,
    partyEmpty: "מקום פנוי",
    boxTitle: "תיבת המחשב",
    boxEmpty: "תיבת המחשב שלך ריקה.",
    moveToBox: "שלח לתיבה",
    moveToParty: "הוסף לקבוצה",
    release: "שחרר",
    releaseConfirm: (name: string) =>
      `האם אתם בטוחים שברצונכם לשחרר את ${name}? לא ניתן לבטל פעולה זו.`,
    wildTitle: "אזור הבר",
    wildSubtitle: "!טיילו בין הדשאים הגבוהים ומצאו פוקימונים פראיים",
    wildEncounter: (name: string) => `!${name} פראי הופיע`,
    wildAppeared: (name: string) => `...${name} מחכה`,
    throwBall: "!זרוק כדור פוקה",
    flee: "ברח",
    noPokeballsTitle: "!אין כדורי פוקה",
    noPokeballsText: "אין לך כדורי פוקה. תצטרך למצוא עוד!",
    catchSuccess: (name: string) => `!תפסת! ${name} נתפס`,
    catchFail: "!אוי לא! הפוקימון ברח",
    catchAdded: (name: string, location: string) =>
      `!${name} התווסף לקבוצה שלך מ${location}`,
    catchBoxed: (name: string) =>
      `!הקבוצה מלאה! ${name} נשלח לתיבת המחשב שלך`,
    partyFull: "הקבוצה מלאה! שלח קודם פוקימון לתיבה.",
    pokeballsLeft: (n: number) => `נשארו ${n} כדורי פוקה`,
    wildOverlayTitle: "!פוקימון פראי",
    wildOverlayText: (name: string) => `${name} פראי נמצא בקרבת מקום!`,
    wildOverlayCatch: "נסה לתפוס!",
    wildOverlayIgnore: "התעלם",
    level: "רמה",
    xp: "ניסיון",
    hp: "כוח חיים",
    maxHp: "כוח חיים מקסימלי",
    seen: "נצפה",
    caught: "נתפס",
    newGame: "משחק חדש",
